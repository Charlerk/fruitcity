...
import com.fruitscity.biz.OrdersBiz;
...
public class OrdersAction extends ActionSupport implements RequestAware,SessionAware {
	...
	public String addOrders() throws Exception {
	    ...
	    while (iter.hasNext()) {
	    	...
	    	orderDts.setGoods(cartItem.getGoods());
	    	orderDts.setGoodsCount(cartItem.getQuantity());
	    	orderDts.setGoodsPrice(cartItem.getGoods().getGoodsPrice());

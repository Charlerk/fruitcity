				...
				<td valign="top" width="80%">
					...
					<s:form action="doUpdateGoods" method="post" enctype="multipart/form-data">
						<table align="center">
							...
							<s:textfield name="goods.goodsName" label="商品名" value="%{#request.updatedGoods.goodsName}" />
							<s:select name="goods.goodsseries.seriesId" label="商品分类" value="%{#request.updatedGoods.goodsseries.seriesId}" list="#request.goodsSeriesList" listKey="seriesId" listValue="seriesName" />  
							<s:textfield name="goods.goodsSummarize" label="摘要" value="%{#request.updatedGoods.goodsSummarize}" />
							<s:textfield name="goods.goodsDescription" label="介绍" value="%{#request.updatedGoods.goodsDescription}" />
							<s:textfield name="goods.goodsPrice" label="价格" value="%{#request.updatedGoods.goodsPrice}"  />

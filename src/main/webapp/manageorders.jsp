	  ...
	  <tr>
		...
		<td width="80">
			<s:if test="pager.curPage>1">
				<A href='/fruitscity/toManageOrders?pager.curPage=1&orders.oid=${requestScope.oid}&orders.orderState=${requestScope.orderState}'>首页</A>&nbsp;&nbsp;
				<A href='/fruitscity/toManageOrders?pager.curPage=${pager.curPage-1 }&orders.oid=${requestScope.oid}&orders.orderState=${requestScope.orderState}'>上一页</A>
			</s:if>
		</td>
		<td width="80">
			<s:if test="pager.curPage < pager.pageCount">
				<A href='/fruitscity/toManageOrders?pager.curPage=${pager.curPage+1}&orders.oid=${requestScope.oid}&orders.orderState=${requestScope.orderState}'>下一页</A>&nbsp;&nbsp;
				<A href='/fruitscity/toManageOrders?pager.curPage=${pager.pageCount }&orders.oid=${requestScope.oid}&orders.orderState=${requestScope.orderState}'>尾页</A>
			</s:if>
		</td>
